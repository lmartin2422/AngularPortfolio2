...
export class ProjectsService {  //COMPLETE THIS WITH REAL VALUES
  ...
  projects: Project[] = [
    ...
    { id: 1, name: 'Robotic Process Automation', pictures:["../../assets/morgan.jpeg", "../../assets/poly.png"], project_link: "https://github.com/lmartin2422/Notepad_website", summary: 'Using UiPath software to perform automations. Pics coming soon!', description: '',  tags: [Tag.UIPATH, Tag.VBNET]},
